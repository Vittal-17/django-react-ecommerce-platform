...
import { FaCreditCard, FaPaypal, FaWallet, FaMapMarkerAlt, FaPhoneAlt } from 'react-icons/fa';
...
const Checkout = () => {
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      // Simulate payment processing time for UX
      setTimeout(async () => {
        try {
          ...
          // Pass the complete order data to the success page via router state
...
const CheckoutContainer = styled.div` max-width: 800px; margin: 0 auto; padding: 2rem; min-height: 100vh; box-sizing: border-box; background: linear-gradient(135deg, #f5f7fa 0%, #e8f5e9 100%); @media(max-width: 768px) { padding: 1rem; } `;
