...
const Overlay = styled(motion.div)`
  position: fixed; inset: 0; background: rgba(15, 23, 42, 0.6); backdrop-filter: blur(8px); display: flex; align-items: center; justify-content: center; z-index: 9999; padding: 1.5rem;
`;

const ModalCard = styled(motion.div)`
  background: #ffffff; padding: 2.5rem 2rem; border-radius: 24px; width: 100%; max-width: 420px; text-align: center; box-shadow: 0 25px 50px -12px rgba(0,0,0,0.25);
...
const ConfirmButton = styled(motion.button)` 
  padding: 0.9rem; border: none; border-radius: 12px; cursor: pointer; font-weight: 700; font-size: 1.05rem; background: #EF4444; color: #ffffff; box-shadow: 0 4px 12px rgba(239, 68, 68, 0.2);
